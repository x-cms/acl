            ...
            <div class="pull-right">
                <form class="search-dtGrid-form" action="">
                    <div class="form-group">
                        <input type="text" id="keyword" name="keyword" class="form-control" placeholder="请输入分类名称作为关键字进行搜索" autocomplete="off">
...
<script>
    var dtGridColumns = [
        ...
        return "<a href='users/"+ record.id +"/edit' class='btn btn-sm btn-warning m-r-5'><i class='fa fa-edit'></i>&nbsp;编辑&nbsp;</a>" +
            "<a href='javascript:;' class='btn btn-sm btn-danger' onclick='del(" + record.id + ")'><i class='fa fa-trash-o'></i>&nbsp;删除&nbsp;</a>";
    } }
    ];
    var dtGridOption = {
        lang: 'zh-cn',
